...
- ✅ Runtime PM service: `s2idle-optimize.service` (active now)
- ✅ Script: `/usr/local/bin/s2idle-optimize.sh`
...
**Related docs:** [SLEEP_OPTIONS_ASSESSMENT.md](SLEEP_OPTIONS_ASSESSMENT.md), [HIBERNATION_SETUP.md](DEPRECATED_HIBERNATION_SETUP.md) (deprecated)
